...
"""StatusNotifierItem/AppIndicator models, parsing, and D-Bus backend."""
...
log = with_context(get_logger(name="status_notifier"), component="backend")
...
@dataclass(frozen=True, slots=True)
class TrayItem:
    """Snapshot of one StatusNotifier item."""
