"""Public package surface for the Calculator applet.
...
Re-exporting ``CalculatorApplet`` here gives the catalog, tests, and documentation a
simple import path without turning the package ``__init__`` into an alternate
implementation layer.
"""

from .applet import CalculatorApplet

__all__ = ["CalculatorApplet"]
