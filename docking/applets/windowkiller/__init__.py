"""Public package surface for the Window Killer applet.
...
Re-exporting ``WindowKillerApplet`` here gives the catalog, tests, and documentation a
...
from .applet import WindowKillerApplet

__all__ = ["WindowKillerApplet", "meta"]
